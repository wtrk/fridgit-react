...
const CorrectiveActions = () => {
        ...
        customBodyRender: (value, tableMeta, updateValue) => {
          return (
            <div>
              <a
                onClick={() => {
                  handleAdd("Edit Corrective Actions - "+tableMeta.rowData[2],tableMeta.rowData[0]);
                }}
              >
                {value}
              </a>
  ...
  const handleAdd = (title, correctiveActionsId) => {
    setOpenAddForm(true);
    setCorrectiveActionsID(correctiveActionsId);
    setFormTitle(title);
  };
      ...
      <div>
        ...
        >
          <SubTables
            ...
            correctiveActionsId={correctiveActionsId}
          />
        </Dialog>
        {/*********************** FILTER start ****************************/}
        <Dialog
