  ...
  const keyPressHandler = (e) => {
    ...
    if(keyCode===13){
      switch (target.nameRef){
        ...
        case "categoryAr": priceRef.current.focus();break;
        case "price": submitRef.current.focus();break;
    ...
    <ToastContainer />
      ...
      <Collapse in={openAlertSuccess}>
        <Alert severity="success" onClick={() => setOpenAlertSuccess(false)}>
          The correctiveAction is successfully created
        </Alert>
      </Collapse>
        ...
        <Grid container spacing={3}>
          ...
          <Grid item xs={12} sm={6}>
            <TextField
              ...
              onKeyDown={keyPressHandler}
              onBlur={validateInputHandler}
              helperText={formErrors.price.error ? formErrors.price.msg : null}
